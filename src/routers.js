...
router.get('/getPantry', isAuthenticated, PantryController.getPantry);
router.post('/pantry/addItem', isAuthenticated, PantryController.addItem);
router.delete(
    '/pantry/removeItem/:item_id',
    isAuthenticated,
    PantryController.removeItem
);
router.put(
    '/pantry/editItem/:item_id',
    isAuthenticated,
...
router.delete(
    '/recipe/removeRecipe/:recipe_id',
    isAuthenticated,
    SavedRecipeController.removeRecipe
);

router.get('/searchRecipes', SearchController.searchRecipes);
router.get(
    '/searchRecipesByIngredients',
    SearchController.searchRecipesByIngredients
);
router.get('/getRecipesById/:recipe_id', SearchController.getRecipesById);
router.get(
    '/getInstructionsById/:recipe_id',
